...
const data = {
  bangkok: ['Rachathevi', 'Pathumwan', 'Dusit'],
  nontaburi: ['Pakkret', 'Bangyai']
};
...
function App() {
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <h1>##### Lab 2 #####</h1>
      <button onClick={() => setIsShow2(false)}>Click to hide me</button>
      {isShow2 && <h1>Text</h1>}
      <h1>##### Lab 3 #####</h1>
      <button
        onClick={() => {
      ...
      >
        ...
        <option value="nontaburi">Nontaburi</option>
      </select>{' '}
      <br />
